...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        Label historylabel = new Label("Press Ctrl-H to show the history.");
        historylabel.setPadding(insets);

        // create a VBox that contains the HBox and the CheckBox
        VBox vBox = new VBox(hBox, checkBox, undolabel, redolabel, historylabel);
        ...
        scene.setOnKeyPressed(event -> {
            ...
            if (event.isControlDown() && event.getCode() == KeyCode.H) {
                // Ctrl-H: show history
                System.out.println("History key combination pressed");
